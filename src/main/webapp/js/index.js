...
function loadIndex() {
    $(document).ready(function () {
        $("#commonContent").load("jsp/common.jsp");
        $("#headerContent").load("jsp/header.jsp");
        $("#mainContent").load("jsp/main.jsp");
        $("#footerContent").load("jsp/footer.jsp");
    });
}
...
function getUser() {
    ...
    if (user_name != null) {
        ...
        cartBtn.onclick = function () {
            $("#mainContent").load("jsp/cart.jsp");
        }
        cartBtn.id = 'my_drug_btn';
        parent.appendChild(cartBtn);
    } else $("#mainContent").load("jsp/main.jsp");
}
